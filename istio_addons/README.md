# Source
This folder and its subfolders were copied from https://github.com/istio/istio/tree/release-1.15/samples/addons
The License at the root of the Istio repository was also copied to indicate how these files are licensed differently from the rest of this repository.
